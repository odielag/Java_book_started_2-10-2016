 ...
 * header: public static double area(int n, double side) Write a main method
 * that prompts the user to enter the number of sides and the side of a regular
...
public class Exercise_6_36__AreaOfARegularPolygon
{
	/** Main method for initializing and testing */
	...
	/** area method for area of a regular polygon */
