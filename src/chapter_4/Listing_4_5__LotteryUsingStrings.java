...
public class Listing_4_5__LotteryUsingStrings {
...
as 08 and number 0 is treated as 00 in the program. Listing 3.8 gives the complete program.
	...
	public static void main(String[] args) {
		...
		if (lotteryPick == 0)
			stringLotteryPick = "00";
		else if (lotteryPick / 10 == 0){
...
// I just pretend that char is similar to String.compareTo or something lol.
